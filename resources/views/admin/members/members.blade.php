...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h3 class="page-title"> Members (<span id="totalMembersCount"></span>) </h3>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="position: relative;">
                    ...
                    <p style="float: right"><a href="worldconsumerclub.com" id="download-qr-code"><strong>Download QR
                                Card (<span id="modalReferralCode"></span>)</strong></a></p>

                    <div class="dp-container" style="position: absolute;top:1rem;right:1rem;">
                        <img src="" alt="" id="dp" height="100px" width="100px"
                            alt="no-image">
                    </div>
                ...
                $('#membersTable').DataTable({
                    ...
                    "rowCallback": function(row, data) {
                        $(row).on('click', function() {
                            ...
                            $('#download-qr-code').attr('href', '{{ url('/') }}' +
                                "/admin/download-qr-card/" + data.id);
                            $('#modalReferralCode').text(data.ReferralCode);
                            if (data.referring_user != null) {
                                $('#modalReferredBy').text(data.referring_user.referring_user
                                    .first_name + ' ' + data.referring_user.referring_user
                                    .last_name);
                            } else {
                                $('#modalReferredBy').text('');
                            }
                            if (data.profile_picture) {
                                $('#dp').attr('src', '{{config('filesystems.disks.s3.url') . '/profile_pictures/'}}' + data.profile_picture)
                            .show();
                            } else {
                                $('#dp').hide();
                            }
