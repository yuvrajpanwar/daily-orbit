...
@section('content')
    <div class="container-fluid mb-4">
        <div class="row justify-content-between">
            <div>
                <h3 class="page-title"> Monthly Winners </h3>
            </div>
    ...
    <div class="container-fluid mb-4">
        ...
        @endif
        <table id="monthlyWinnersTable" class="table table-striped" style="width:100%">
            <thead>
                <tr>
                    <th style="color: blue"><b>S.No.</b></th>
                    <th style="color: blue"><b>Winning Month</b></th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="monthlyWinnersTableBody">
        ...
        $(document).ready(function() {
            ...
            function createTable(joinSpan, userType, sortBy) {
                $('#monthlyWinnersTable').DataTable({
                    ...
                    "ordering": false,
                    "ajax": {
                        "url": "{{ route('fetch-monthly-winners') }}",
                        "data": {
                            _token: "{{ csrf_token() }}",
                            'joinSpan': joinSpan,
                            'userType': userType,
                    ...
                    "columns": [{
                        ...
                        {
                            "data": "winningMonth",
                            "name": "monthly_winners.winning_date"
                        },
                        {
            ...
            $(document).on('click', '.this-users-referrals', function(event) {
                ...
                $.ajax({
                    ...
                    `;
                            ...
                            $('#monthlyWinnersTableBody').html(tableBody);
