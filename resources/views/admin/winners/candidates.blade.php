...
<div class="container-fluid mb-4">
    <div class="row justify-content-between">
        <div>
            <h3 class="page-title"> Today's Winner Candidates </h3>
        </div>
        <div class="d-flex">
            <div class="mr-4">
            ...
            <div >
                <a href="{{route('admin.excluded-list')}}">
                    <button class="btn btn-primary" style="text-wrap:nowrap">Exluded List</button>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid mb-4">
        ...
        @endif
        <table id="candidatesTable" class="table table-striped" style="width:100%">
            <thead>
                <tr>
