...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h3 class="page-title">Add New Advisory </h3>
            </div>
        </div>
    </div>
    <div class="container-fluid mb-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-end">
                <a href="{{ route('admin.advisories') }}"><button class="btn btn-primary"> <i class="fe fe-16 fe-arrow-left"></i>All Advisoris </button></a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="card col-md-7">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('store-advisory')}}">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100" name="advisory_title" id="advisory_title"
                                    value="{{ old('advisory_title') }}" required maxlength="70">
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <textarea class="w-100" name="advisory_description" id="advisory_description" cols="30" rows="10" required maxlength="500"></textarea>
