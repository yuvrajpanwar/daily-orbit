...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h3 class="page-title">Edit Appreciation </h3>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="card col-md-6">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update-appreciation', ['appreciation' => $appreciation->id]) }}">
                        @csrf
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                <label>Title</label>
                                <input type="text" class="form-control w-100" name="title_by_admin" id="title_by_admin"
                                    value="{{ $appreciation->title_by_admin }}" required maxlength="70">
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <textarea class="w-100" id="description_by_admin" name="description_by_admin" cols="30" rows="10" required
                                    maxlength="600">{{ $appreciation->description_by_admin }}</textarea>
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100" id="company_name_by_admin"
                                    name="company_name_by_admin" value="{{ $appreciation->company_name_by_admin }}"
