                        ...
                        <div class="form-row">
                            ...
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100 @error('phone') is-invalid @enderror"
                                    name="phone" id="phone" value="{{ old('phone') }}" required maxlength="100">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100 @error('password') is-invalid @enderror" name="password" id="password"
                                    rows="4" maxlength="500">{{ old('password') }}</input>
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
