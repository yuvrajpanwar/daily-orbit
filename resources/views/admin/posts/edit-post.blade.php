        ...
        <div class="row">
            ...
            <div class="card col-md-7">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update-post', ['post' => $post->id]) }}"  id="add-post" >
                        @csrf
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                <label>Title</label>
                                <input type="text" class="form-control w-100" name="post_title" id="post_title"
                                    value="{{$post->post_title}}" required maxlength="70">
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <textarea class="w-100" name="post_description" id="post_description" cols="30" rows="10" required maxlength="500">{{$post->post_description}}</textarea>
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100" name="company" id="company"
                                    value="{{$post->company}}" required maxlength="50">
                        ...
                        <div class="form-row">
                            <div class="mb-3 w-100">
                                ...
                                <input type="text" class="form-control w-100" name="author" id="author"
                                    value="{{$post->author}}" required maxlength="20">
